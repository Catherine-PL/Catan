...
public class Building extends Element {
	...
	String textYC="Ju¿ znajduje siê tu twoje miasto";
	
	public void buildSettlement(Player player,Node here)// player kto buduje, here gdzie
	{
	...
	public void buildCity(Player player, Node here)
	{
